...
void ModbusStreamWriter_WriteUInt16(ModbusStreamWriter *self, uint16_t data)
{
	...
	Modbusbsp__bit_converter__GetBytesFromUInt16(self->_unit,
												 data,
												 temp_buffer,
												 0);
...
{
	uint8_t temp_buffer[sizeof(data)];
	Modbusbsp__bit_converter__GetBytesFromUInt32(self->_unit,
												 data,
												 temp_buffer,
												 0);
...
{
	uint8_t temp_buffer[sizeof(data)];
	Modbusbsp__bit_converter__GetBytesFromUInt64(self->_unit,
												 data,
												 temp_buffer,
												 0);
...
{
	uint8_t temp_buffer[sizeof(data)];
	Modbusbsp__bit_converter__GetBytesFromFloat(self->_unit,
												data,
												temp_buffer,
												0);
...
{
	uint8_t temp_buffer[sizeof(data)];
	Modbusbsp__bit_converter__GetBytesFromDouble(self->_unit,
												 data,
												 temp_buffer,
												 0);
