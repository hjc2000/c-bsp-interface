...
inline void bsp__auto_bit_converter__get_bytes_from_uint16(bsp__auto_bit_converter *self, uint16_t value, uint8_t *out_buffer, int32_t offset)
{
...
inline void bsp__auto_bit_converter__get_bytes_from_int16(bsp__auto_bit_converter *self, int16_t value, uint8_t *out_buffer, int32_t offset)
{
...
inline void bsp__auto_bit_converter__get_bytes_from_uint32(bsp__auto_bit_converter *self, uint32_t value, uint8_t *out_buffer, int32_t offset)
{
...
inline void bsp__auto_bit_converter__get_bytes_from_int32(bsp__auto_bit_converter *self, int32_t value, uint8_t *out_buffer, int32_t offset)
{
...
inline void bsp__auto_bit_converter__get_bytes_from_uint64(bsp__auto_bit_converter *self, uint64_t value, uint8_t *out_buffer, int32_t offset)
{
...
inline void bsp__auto_bit_converter__get_bytes_from_int64(bsp__auto_bit_converter *self, int64_t value, uint8_t *out_buffer, int32_t offset)
{
...
inline void bsp__auto_bit_converter__get_bytes_from_float(bsp__auto_bit_converter *self, float value, uint8_t *out_buffer, int32_t offset)
{
...
inline void bsp__auto_bit_converter__get_bytes_from_double(bsp__auto_bit_converter *self, double value, uint8_t *out_buffer, int32_t offset)
{
